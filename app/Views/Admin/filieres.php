        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="/admin/add_filiere"  class="form">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <button type="button" class="btn btn-default" onclick="window.location='filieres.php'" style="background-color: #afc8a4; color: #385e82">Annuler</button>
                            </div>
                        </div>
                        <hr class="new1">
