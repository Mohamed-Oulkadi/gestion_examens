    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Assign Modules to Professors</h1>
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        $professors = [
                            ['1', 'Dr. John Smith', ['Programming Basics', 'Data Structures']],
                            ['2', 'Dr. Jane Doe', ['Algorithms', 'Database Systems']],
                        ];
                        ...
                        foreach ($professors as $prof) {
                            ...
                            echo "<td>{$prof[1]}</td>";
                            echo "<td>";
                            foreach ($prof[2] as $module) {
                                echo "<span class='badge bg-primary me-1'>$module</span>";
                            }
                            echo "</td>";
                            echo "<td>
                                    <button class='btn btn-sm btn-primary' onclick='editAssignment({$prof[0]})'>
